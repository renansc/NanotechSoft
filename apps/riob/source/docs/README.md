...
- o Workflow de Vendas Diario possui `Listar cargas da semana`: a semana e escolhida no calendario e a tabela mostra cada carga PDF, inclusive as ja enviadas ao Kanban, com motorista, entregador, vendedor, caminhao, placa, cidade, rota, peso e quantidade de entregas
