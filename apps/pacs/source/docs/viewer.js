(function () {
  const DOCS = [
    {
      file: "README.md",
      title: "Guia Geral",
      description: "Mapa do portal de docs, publico-alvo e leitura recomendada.",
    },
    {
      file: "ARQUITETURA_SISTEMA.md",
      title: "Arquitetura",
      description: "Visao geral da arquitetura, modulos, armazenamento e integracoes.",
    },
    {
      file: "USO_E_FLUXOS_FUNCIONAIS.md",
      title: "Uso e Fluxos",
      description: "Guia funcional do cockpit, menu a menu, com as rotinas operacionais.",
    },
    {
      file: "DIAGRAMAS_E_PROCESSOS.md",
      title: "Diagramas",
      description: "Fluxogramas e sequencias Mermaid dos processos principais do raioXPacs.",
    },
    {
      file: "OPERACAO_E_DEPLOY.md",
      title: "Operacao e Deploy",
      description: "Runbook operacional, bootstrap, variaveis, backup, Render e troubleshooting.",
    },
    {
      file: "API_E_DADOS.md",
      title: "API e Dados",
      description: "Referencia das rotas HTTP, servicos DICOM/MWL e do modelo de dados.",
    },
  ];
  ...
  function setDocMeta(file) {
    ...
    document.title = `${doc.title} | Documentacao raioXPacs`;
  }
